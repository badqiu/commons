...
public class FastBeanUtil {
	...
	private static void copyProperties(Object source, Object target, Class<?> editable, String... ignoreProperties)
		...
		HashSet<String> ignoreList = (ignoreProperties != null) ? new HashSet(Arrays.asList(ignoreProperties)) : null;
	...
	private static void setProperty(Object target, PropertyDescriptor targetPd,
		...
		Object targetValue = FastConvertUtil.convert(targetClass,value);
