...
public class SimpleHttpInvokerRequestExecutorTest {
	...
	public void test() throws Exception {
		 ...
		 sh.executeRequest("http://localhost:8080/userdata/importData.do?username=yuminxiong&password=iXZfu38dfdo20M8Odw9eJR5dfeQ2ogy4o0Oet4G&importMode=append&appId=lj&module=master", r);
	}
